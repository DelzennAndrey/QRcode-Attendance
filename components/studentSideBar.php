...
<button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <aside id="logo-sidebar" class="shadow-lg bg-gray-100 fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
       ...
       <div class="shadow-inner bg-gray-200 p-2 rounded-2xl mb-5">
       ...
       <ul class="space-y-2 font-medium">
         ...
         <a href="../model/logOut.php" class="font-medium mt-36 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-red-600 hover:text-white dark:hover:bg-red-600 group">
            ...
            <button class="ms-3 whitespace-nowrap text-xl">Log Out</button>
         </a>
    </div>
 </aside>
